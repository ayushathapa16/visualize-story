...
>
> **Narrator:** Every spring, birds return to Toronto after journeys that span
> entire continents. This city is home to us. It is home to them too.

*It said "millions of birds" until 2026-07-27. Nothing in the repo supported the
number and the piece's opening sentence is the worst place to guess; the count
...
Flyway - the Caribbean to Lake Ontario.

> **Willow:** "I've been flying for weeks. Somehow… I always find my way back."
>
> **Narrator:** Tree Swallows spend the winter around the Gulf of Mexico, Florida
> and the Caribbean, then travel thousands of kilometres north every spring to
> breed.

*This said "Central and South America", and the route in `globe.js` started in
Brazil to match. It was simply wrong - Tree Swallows do not go to South America.
Knight et al. 2019 tracked 133 of them with geolocators: the nonbreeding range is
the Gulf, Florida, Mexico, Central America and the Caribbean, and eastern-flyway
birds (Toronto's) winter in Florida and the Caribbean. Corrected 2026-07-27, in
the script, the narration and the globe. See `docs/sources.md` §G3.*
...
## ACT VI-B — THE EVIDENCE

*Three data scenes, and the only stretch of the piece where a chart is evidence
rather than illustration. Every mark is a published value; every frame carries its
citation on the stage. They sit here on purpose - after "my story isn't unique",
before "what can I do" - so the reader meets the numbers already caring about them.*

*Source: Filazzola A, Johnson MTJ, Barrett K, Hayes S, Shrestha N, Timms L,
...
> **Willow:** "It isn't only my city."
>
> **Narrator:** Researchers modelled 2,019 animal species across the largest cities
> in Canada and the United States. Every bar is one city: what it loses, and what
> arrives to replace it.

*888 species have a suitable climate in Toronto today; the models predict 159–360
gained and 40–195 lost by 2081–2100, depending on emissions. **This is turnover,
...
> **Willow:** "How many of us can still live here?"
>
> **Narrator:** Of the animals modelled for Toronto, 354 are birds. Today 218 of
> them find a climate here they can live in. New species arrive as the city warms -
> but for birds, fewer arrive than leave.
...
> **Willow:** "Some of us were already struggling."
>
> **Narrator:** Before any of those futures arrive, the birds modelled for Toronto
> are assessed today. Most are of Least Concern - but 138 of them already have
> declining populations.

*6 Vulnerable, 18 Near Threatened, 138 decreasing. **This is IUCN's assessment, not
a finding of the paper**, and the label says so. The paper's own caveat travels with
it: at-risk species were not necessarily the ones most vulnerable to climate change
- they are already declining from other pressures. The habitat split is the honest
answer to "where do they live?": the paper has no habitat classification at all, so
the only evidence is IUCN's, it is coarse, and species hold more than one - which is
why the three counts sum past 354.*
...
>
> **Narrator:** Every spring, birds choose Toronto. Whether they can
