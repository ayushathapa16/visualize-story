...
// It is deliberately introduced HERE, on the good evening, because Scene 12
...
export default {
  ...
  build(ctx) {
    ...
    // same 18.5 °C that Scene 12 turns into a cold snap. Saying it here, while
    // the sky is full, is what makes Scene 12's version land - it is the same
