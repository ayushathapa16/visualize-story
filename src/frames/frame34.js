// Scene 34 - One Last Flight. The story closes where it opened.
//
...
export default {
  ...
  build(ctx) {
    ...
    // We start where Scene 28 left us: close on the nest.
    ...
    const nEnd = narrate(
      {
        narrator:
          // "millions of birds" until 2026-07-27, in the closing sentence and in
          // Scene 1's opening one. Neither was sourced. Both dropped the
          // magnitude rather than reaching for a count nobody here has - and the
          // pair has to stay matched, because this line is deliberately Scene
          // 1's line coming back round.
          'Every spring, birds choose Toronto. Whether they can keep calling it home depends, in part, on the choices we make now.',
      },
      'center',
      'narration--on-dark'
    );
