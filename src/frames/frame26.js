// Scene 26 - Zooming Out. Beat: REFLECTION. "Who else is up there?"
//
...
export default {
  ...
  build(ctx) {
    ...
    // Same panelContent shape Scenes 20, 27 and 31 use, so no new component and
    ...
    const trigger = panelTrigger({
      ...
      content: {
        ...
        body: [
          ...
          'Scenes 29 to 21 take this apart properly.',
        ],
        facts: [
