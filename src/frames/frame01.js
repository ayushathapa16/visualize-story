...
export default {
  ...
  build(ctx) {
    ...
    const n1 = narrate({
      ...
      // "MILLIONS of birds" until 2026-07-27, and nothing in the repo supported
      // it. The number is probably not even wrong - Toronto sits on a major
      // flyway - but nobody here has a count, the source that could give one
      // (Tommy Thompson Park's daily totals, docs/sources.md §D) has never been
      // downloaded, and this is the piece's opening sentence. The story does not
      // need the magnitude: "birds return, after journeys that span continents"
      // is the same image and is true without a citation. If TTPBRS is ever
      // wired up, put a real figure back and cite it.
      narrator:
        'Every spring, birds return to Toronto after journeys that span entire continents. This city is home to us. It is home to them too.',
    });
