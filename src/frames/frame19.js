// Scene 19 - The Great Urban Shift. Beat: EVIDENCE. "It isn't only Toronto."
//
...
// Everything before this frame is illustrative on purpose; from here to Scene 21
...
//     Fig 1's legend say. climateProjections.csv (Scene 20) says ssp370. We do
...
export default {
  ...
  build(ctx) {
    ...
    // SSP5-8.5 - the scenario Scene 17's +3 °C thermometer corresponds to, and
    ...
    // frame and Scene 20 label their scenarios with nothing but the code - the
