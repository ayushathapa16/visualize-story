// Scene 19 - The Clock Breaks. Beat: UNEASE→CONFUSION. "What does that cost her?"
//
...
// breaking, and then Scene 20 explains what broke.
...
export default {
  ...
  build(ctx) {
    ...
    // Lifted and pulled back, as in Scenes 9 and 13 - the lower station labels
