// Scene 21 - A Difficult Decision. Beat: STRESS. "Was that the right call?"
//
...
//
// The pick is remembered and Scene 22 plays it out.
//
...
export default {
  ...
  build(ctx) {
    ...
    const cal = layDateCalendar({
      ...
      onPick(id) {
        setChoice(id);
        // A held beat, then her answer to it. The outcome belongs to Scene 22.
