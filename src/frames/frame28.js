// Scene 28 - One Bird's Story. Beat: REFLECTION→HOPE. "So what do we do?"
//
// The exact inverse of Scene 26: that scene pulled out from her nest until it
...
export default {
  ...
  build(ctx) {
    ...
    // The city full of other birds - where Scene 27 left us.
