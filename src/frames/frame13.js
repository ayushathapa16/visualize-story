// Scene 13 - An Earlier Spring. Beat: UNEASE. "Where is she?"
//
// The same seasonal clock as Scene 9, running the same sequence - but early. The
...
export default {
  ...
  build(ctx) {
    ...
    clock.showLabels(); // we already learned these in Scene 9
    ...
    // land in the caption band (see Scene 9).
